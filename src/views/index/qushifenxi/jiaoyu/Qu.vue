<template>
  <div class="trend">
    <div class="main-left">
      ...
      <!-- 区教育局 -->
      <div class="hezi" style="padding: 0.14rem;">
        <div class="shitang">
          <div class="title">
            <p>食材供应商总量</p>
            <p>4,498</p>
    ...
    <div class="main-mid">
      ...
      <div class="map hezi">
        <div class="title">
          <span>叙永县地域分布图</span>
          <span class="time" @click="back_url()" v-show="user!== 'qujiaoyu'">返回</span>
        </div>
    ...
    initEcharts8() {
      ...
      axios
        ...
        .then(response => {
          ...
          var schoolMap = {
            叙永县实验小学: [105.449105, 28.172379],
            麦地坝小学: [105.43677,28.388747],
            普兴小学: [105.492705, 27.817373]
          };
          var b_list = [
            {
              name: "叙永县实验小学",
