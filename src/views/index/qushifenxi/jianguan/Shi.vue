<template>
  <div class="trend">
    <div class="main-left">
      ...
      <div
        class="hezi"
        style="position:absolute;top:60%;width:4.62rem;padding:.2rem 0;height:2rem;line-height:3em;"
      >
        <div class="shitang">
          <div class="title">
            <p>食材供应商总量</p>
    ...
    <div class="main-mid">
      ...
      <div class="map hezi">
        <div class="title">
          <span>泸州市域地域分布图</span>
          <span class="time" @click="back_url()" v-show="user !=='shijianguan'">返回</span>
        </div>
        <div class="tu" ref="shi"></div>
      </div>
    </div>
